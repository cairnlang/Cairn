...
- `examples/prelude/web_helpers.crn`: auto-loaded web-response helpers (`http_html_ok`, `http_text_not_found`, `http_html_file_ok`)
...
- `examples/web/hello_static.crn`: tiny two-page static server with Cairn-owned route-handler functions and explicit bind address support (`HTTP_SERVE`)
