...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0v)
...
- **v0.6.0v** (current): PRE normalization adds guarded one-step distribution (`A OR (B AND C)`) to expose implication collapses in generated guard shapes
