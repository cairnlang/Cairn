...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0m)
...
- **v0.6.0m** (current): PROVE normalizes composed helper booleans (idempotence/complement/absorption) to preserve MATCH narrowing
