...
- `examples/web/hello_static.crn`: tiny two-page static server with Cairn-owned `GET` route helpers, parsed query visibility, explicit bind address support, and `GET`-only request handling (`HTTP_SERVE`)
