...
- **v0.7.0i** (current): Shared actor/state helper libs plus a practical notifier actor example
- **v0.7.0** (next): Typed BEAM concurrency runtime completion (supervision ergonomics, richer actor patterns)
