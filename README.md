...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0w)
...
- **v0.6.0w** (current): PRE normalization adds bounded consensus reduction (`(A OR B) AND (A OR NOT B) => A`) for noisy generated conjunctions
