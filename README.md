...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0j)
...
- **v0.6.0j** (current): JSON trace adds run start/end metadata, event indices, match site ids, and assumption snapshots
