...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0k)
...
- **v0.6.0k** (current): JSON trace adds proof lifecycle events and UNKNOWN/ERROR reason fields in run-end metadata
