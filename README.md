...
# Tag-bound + helper-comparison constructor narrowing demos (new v0.6.0aa slice)
...
- **v0.6.0aa** (current): PROVE broadens helper-pattern extraction to `eq/neq` and simple affine wrappers around tag-boolean `ite` encodings
- **v0.6.x** (next): Extend helper-pattern coverage to additional generated expression families
