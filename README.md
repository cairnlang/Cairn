...
`examples/practical/main.ax`, `examples/practical/ledger.ax`, `examples/practical/todo.ax`, `examples/practical/ledger_cli.ax`, `examples/practical/expenses.ax`, and `examples/practical/cashflow.ax` demonstrate practical, non-PROVE-centric workflows:
...
- **v0.6.2d** (current): Practical programs pass 4 (cross-file cashflow composition + shared report/assert helpers)
- **v0.6.2e** (next): Practical programs pass 5 (richer invariants and multi-step pipeline composition)
