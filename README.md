...
- **v0.6.2e** (current): Practical programs pass 5 (cashflow-alerts pipeline stage with risk classification)
- **v0.6.3** (next): Practical milestone consolidation and final polish pass
