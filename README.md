...
# Helper-boolean PRE refinement for MATCH pruning (new v0.6.0l slice)
mix axiom.run examples/prove/proven_shape_refine.ax

# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0l)
...
- **v0.6.0l** (current): PROVE broadens refinement inference to helper-boolean equality forms (`... T EQ`) for MATCH pruning
