...
# PROVE trace diagnostics for pruned/explored MATCH branches (v0.6.0s)
...
- `match_decision` (with `event_index`, `match_site_id`, `phase`, `assumptions`, `explored`, `pruned`, `reason`)
...
- **v0.6.0s** (current): PRE normalization prunes local contradiction/tautology comparison pairs (same expression, integer constants) to reduce noisy guard branches
