...
6. Load typed-concurrency examples:
...
7. Inspect loaded prelude: `./cairn --show-prelude examples/prelude/ini_parse.crn`
8. Try diagnostics JSON: `./cairn --json-errors examples/diagnostics/runtime_div_zero.crn`
9. Run practical-only tests: `mix test.practical`
