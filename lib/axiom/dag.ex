defmodule Axiom.DAG do
  ...
  """
  @spec put(Axiom.Types.Node.t()) :: Axiom.Types.Node.t()
  def put(%Axiom.Types.Node{} = node) do
  ...
  """
  @spec get(String.t()) :: Axiom.Types.Node.t() | nil
  def get(hash) do
  ...
  """
  @spec subgraph(String.t()) :: [Axiom.Types.Node.t()]
