defmodule Axiom.Diagnostic do
  ...
  def from_exception(%Axiom.StaticError{} = e, path) do
  ...
  def from_exception(%Axiom.RuntimeError{message: message}, path) do
  ...
  def from_exception(%Axiom.ContractError{message: message}, path) do
    word = extract_word(message)
