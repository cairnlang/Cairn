defmodule Axiom.Loader do
  @moduledoc """
  Loads Axiom source files with recursive IMPORT resolution.
  """

  alias Axiom.{Lexer, Parser}

  @type parsed_item ::
          Axiom.Types.Function.t()
          | Axiom.Types.TypeDef.t()
          | {:expr, [Axiom.Types.token()]}
