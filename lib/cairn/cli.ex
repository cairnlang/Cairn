defmodule Cairn.CLI do
  ...
  @prelude_modules [
    ...
    {"lib/prelude/web.crn", ["http_html_ok", "http_text_ok", "http_text_not_found", "http_text_method_not_allowed", "http_html_file_ok", "route_html_file", "route_get_html_file", "route_text_ok", "route_get_text", "route_or", "route_finish", "route_finish_get"]},
