defmodule Cairn.Solver.Prove do
  @moduledoc """
  ...
  alias Cairn.Solver.{PreNormalize, Symbolic, SmtLib, Z3}
  ...
  defp trace_level(env) do
    ...
    sys_value = System.get_env("CAIRN_PROVE_TRACE")
  ...
  defp clear_trace_events do
    Process.put(:cairn_prove_trace_events, [])
  end
  ...
  defp get_trace_events do
    (Process.get(:cairn_prove_trace_events) || [])
    |> Enum.reverse()
  end
