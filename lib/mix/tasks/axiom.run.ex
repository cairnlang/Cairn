defmodule Mix.Tasks.Axiom.Run do
  ...
  @example_groups [
    ...
    {"concurrency", ["examples/concurrency/ping_pong_types.ax", "examples/concurrency/traffic_light_types.ax", "examples/concurrency/traffic_light.ax", "examples/concurrency/ping_once.ax", "examples/concurrency/self_boot.ax", "examples/concurrency/two_pings.ax", "examples/concurrency/counter.ax", "examples/concurrency/notifier.ax", "examples/concurrency/restart_once.ax"]},
