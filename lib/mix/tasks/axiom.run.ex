defmodule Mix.Tasks.Axiom.Run do
  ...
  @example_groups [
    ...
    {"practical", ["examples/practical/all_practical.ax", "examples/practical/main.ax", "examples/practical/ledger.ax", "examples/practical/todo.ax", "examples/practical/ledger_cli.ax", "examples/practical/expenses.ax", "examples/practical/cashflow.ax", "examples/practical/cashflow_alerts.ax", "examples/practical/mini_grep.ax", "examples/imports/main.ax", "examples/json/demo.ax"]},
